## Introduction
**Meal App** - A Test Project with Next.js, React, TypeScript & Tailwind CSS.

**Meal App Link** - https://cmlabs-fe-aji-test.vercel.app

## Installation

1. Clone the repository ```git clone https://github.com/ajibon153/cmlabs-frontend-fulltime-test``` or download zip.
2. Open the directory ```cmlabs-frontend-fulltime-test``` in the terminal.
